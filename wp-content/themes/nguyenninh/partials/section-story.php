...
?>
<section class="position-relative section-story title-block-common" style="background: url(<?php echo get_template_directory_uri(); ?>//assets/imgs/IMG_9840.jpg);">
    ...
    <div class="container z-3 position-relative">
        <div class="d-flex flex-col align-items-center pt-96 pb-96 mx-[3rem]">
            ...
            <div class="title-main d-flex align-items-center text-center">
